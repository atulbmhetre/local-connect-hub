-- Pass optional UPI QR URL through atomic vendor registration.
...
COMMENT ON FUNCTION public.register_vendor(
  ...
  'Atomically creates vendor row, vendor_categories, and 7 verification checks. Optional upi_qr_url.';
