-- Rate-limit register_vendor by phone: 3 attempts per 5 minutes.
...
COMMENT ON FUNCTION public.register_vendor(
  ...
  'Atomically creates vendor row, vendor_categories, and 7 verification checks. Optional upi_qr_url and upi_qr_payee_id. Rate-limited by phone.';
