-- Align TEST with PROD: total_price is a generated column (quantity * unit_price),
-- not RPC-computed. PROD already has this; TEST had a plain nullable column.

ALTER TABLE public.order_items DROP COLUMN total_price;
