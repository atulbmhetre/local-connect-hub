-- FCM push on order expiry via notify-user (TEST: hhdylnhqdzfabsolwxdz).
...
DECLARE
  ...
  notify_url text := 'https://hhdylnhqdzfabsolwxdz.supabase.co/functions/v1/notify-user';
  notify_anon_key text := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhoZHlsbmhxZHpmYWJzb2x3eGR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA0NDQ0ODEsImV4cCI6MjA5NjAyMDQ4MX0.CWGB3IcOmFK7NsHIy6bgPulRfVGRuDxXDzdEZ7V777s';
