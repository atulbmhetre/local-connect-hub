-- Fix parameter name mismatch in create_customer_request call to _resolve_booking_category
-- The function expects p_hint_category_id and p_hint_service_mode, but was being called with p_category_id and p_service_mode
...
BEGIN
  ...
  -- Category resolution logic - FIXED: Use correct parameter names
