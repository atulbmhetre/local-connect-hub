-- Create missing _resolve_booking_category helper function
-- This extracts the exact category/service-mode resolution logic from 
-- create_customer_request to support the structured items migration
