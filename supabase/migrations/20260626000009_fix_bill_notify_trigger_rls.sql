-- Phase C user_notifications RLS blocked inbox inserts from notify_order_bill_trigger.
-- Disable row_security inside the SECURITY DEFINER trigger so bill INSERT always creates inbox rows.
