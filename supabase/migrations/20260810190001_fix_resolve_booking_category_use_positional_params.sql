-- Fix function call by using positional parameters instead of named parameters
-- This avoids PostgreSQL parameter name resolution issues
...
BEGIN
  ...
  -- Category resolution logic - FIXED: Use positional parameters
