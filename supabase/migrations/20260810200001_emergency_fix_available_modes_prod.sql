-- EMERGENCY FIX: Replace vc.available_modes with correct vendor_category_modes query
-- PROD is down - customers cannot place orders due to missing column reference
