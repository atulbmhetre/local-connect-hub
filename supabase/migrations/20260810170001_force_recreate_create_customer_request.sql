-- Force recreation of create_customer_request to clear any cached references
-- This should resolve the function lookup issue

-- Drop the function entirely first
...
-- Recreate it with the exact same logic but forced recompilation
...
BEGIN
  ...
  -- Category resolution logic - call the helper function with explicit parameters
