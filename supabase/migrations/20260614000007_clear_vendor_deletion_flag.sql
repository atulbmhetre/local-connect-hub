-- R15/G10: Clear vendors.deletion_requested_at after vendor anonymization completes.
...
COMMENT ON FUNCTION public.anonymise_deleted_accounts() IS
  'Anonymises customer PII immediately on deletion request; vendor profiles after 30 days. G2/G4/G5/G7/G10/R15 extensions.';
