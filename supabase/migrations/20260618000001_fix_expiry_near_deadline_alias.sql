-- Fix PostgreSQL 42P01: UPDATE ... FROM cannot reference the target alias (r) in the FROM join list.
-- Join vendors via groups.vendor_id instead; expire_pending_orders calls this function first.
