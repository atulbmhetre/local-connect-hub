-- VR-REG-06: Draft/incomplete vendor profiles + profile_status on register_vendor.
...
REVOKE ALL ON FUNCTION public.register_vendor(
  ...
  double precision, double precision, text, text, uuid[], text[]
) FROM PUBLIC;
...
COMMENT ON FUNCTION public.register_vendor(
  ...
  'Atomically creates vendor row, vendor_categories, and 7 verification checks. VR-REG-01/02/06.';
